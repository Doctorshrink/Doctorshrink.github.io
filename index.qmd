...
> "My anxiety dropped from an 8 to a 3 right before a job interview." - @Leah K.

> "The first time I cried and actually felt safe doing it in a long time." - @Carlos D.

> "I turned a messy breakup text into a gorgeous piano ballad and felt so much better." - @Sam R.
...
```{=html}
    ...
    <footer>
        <address>
            <strong>TheDataShrink™</strong> · ABN 52 870 528 853 · Brisbane QLD ·
            <a href="mailto:thedatashrink@gmail.com">thedatashrink@gmail.com</a>
        </address>
        <nav>
            <!-- Create these pages later if needed -->
            <!-- <a href="/privacy">Privacy</a> · <a href="/terms">Terms</a> -->
        </nav>
        <small>© 2025 Doctor Shrink</small>
    </footer>
